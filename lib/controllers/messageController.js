...
function createMessage(_x, _x2, _x3) {
  return _createMessage.apply(this, arguments);
} // Get all messages for a specific group
function _createMessage() {
  _createMessage = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res, io) {
    var _req$body, senderId, content, groupId, group, sender, attachments, message;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          _req$body = req.body, senderId = _req$body.senderId, content = _req$body.content, groupId = _req$body.groupId;
          _context.next = 4;
        ...
        case 7:
          ...
          return _context.abrupt("return", res.status(404).json({
            error: "Group or sender not found"
          }));
        case 10:
          attachments = [];
...
function getMessagesByGroup(_x4, _x5) {
  return _getMessagesByGroup.apply(this, arguments);
} // Get a specific message by ID
function _getMessagesByGroup() {
  _getMessagesByGroup = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(req, res) {
    var messages, messagesWithVietnamTime;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 3:
          ...
          messagesWithVietnamTime = messages.map(function (msg) {
...
function getMessageById(_x6, _x7) {
  return _getMessageById.apply(this, arguments);
} // Update a message by ID
function _getMessageById() {
  _getMessageById = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(req, res) {
    var message, messageWithVietnamTime;
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          _context3.prev = 0;
          _context3.next = 3;
          return Message.findById(req.params.id).populate("sender group");
        case 3:
        ...
        case 6:
          ...
          messageWithVietnamTime = _objectSpread(_objectSpread({}, message.toObject()), {}, {
...
function updateMessage(_x8, _x9) {
  return _updateMessage.apply(this, arguments);
} // Delete a message by ID
function _updateMessage() {
  _updateMessage = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(req, res) {
    var message;
...
function _deleteMessage() {
  _deleteMessage = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5(req, res) {
    var message;
